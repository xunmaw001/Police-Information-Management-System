    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="领导名称" prop="lingdaoName">
                       <el-input v-model="ruleForm.lingdaoName"
                                 placeholder="领导名称" clearable  :readonly="ro.lingdaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="领导名称" prop="lingdaoName">
                           <el-input v-model="ruleForm.lingdaoName"
                                     placeholder="领导名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="领导身份证号" prop="lingdaoIdNumber">
                       <el-input v-model="ruleForm.lingdaoIdNumber"
                                 placeholder="领导身份证号" clearable  :readonly="ro.lingdaoIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="领导身份证号" prop="lingdaoIdNumber">
                           <el-input v-model="ruleForm.lingdaoIdNumber"
                                     placeholder="领导身份证号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.lingdaoPhoto" label="领导头像" prop="lingdaoPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.lingdaoPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="领导邮箱" prop="lingdaoEmail">
                       <el-input v-model="ruleForm.lingdaoEmail"
                                 placeholder="领导邮箱" clearable  :readonly="ro.lingdaoEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="领导邮箱" prop="lingdaoEmail">
                           <el-input v-model="ruleForm.lingdaoEmail"
                                     placeholder="领导邮箱" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   lingdaoEmail: [
                              { required: true, message: '领导邮箱不能为空', trigger: 'blur' },
