        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '领导名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.lingdaoName" placeholder="领导名称" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jingwuxinxiguanli/upload/lingdaoMuBan.xls"
                        >批量导入领导数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('lingdao','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="lingdaoIdNumber"
                                   header-align="center"
                                   label="领导身份证号">
                        <template slot-scope="scope">
                            {{scope.row.lingdaoIdNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="lingdaoPhoto"
                        ...
                        <template slot-scope="scope">
                            <div v-if="scope.row.lingdaoPhoto">
                                <img :src="$base.url+scope.row.lingdaoPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>
